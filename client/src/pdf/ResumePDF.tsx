    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>{personalInfo.fullName}</Text>
          ...
          <Text style={styles.text}>{personalInfo.linkedin}</Text>
          <Text style={styles.text}>{personalInfo.github}</Text>
          <Text style={styles.text}>{personalInfo.portfolio}</Text>
        </View>
